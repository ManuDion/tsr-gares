        ...
        <div class="panel">
            ...
            <dl class="definition-list">
                ...
                <div>
                    ...
                    <dd>
                        @php $activityMode = $gare->activity_mode ?? 'mixed'; @endphp
                        {{ $activityMode === 'inter_only' ? 'Inter uniquement' : ($activityMode === 'national_only' ? 'National uniquement' : 'Inter et national') }}
                    </dd>
                </div>
