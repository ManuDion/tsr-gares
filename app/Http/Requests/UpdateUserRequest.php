        ...
        $validator->after(function ($validator) {
            ...
            if ($actor?->isServiceAdmin()) {
                ...
                if (! $module || $module !== $actorModule) {
                    $validator->errors()->add('module', 'Vous pouvez mettre a jour des utilisateurs uniquement dans votre service.');
                }
                ...
                if ($role->isUniversalSupervisor()) {
                    $validator->errors()->add('role', 'La promotion vers un role universel est reservee a l\'administration generale.');
                }
